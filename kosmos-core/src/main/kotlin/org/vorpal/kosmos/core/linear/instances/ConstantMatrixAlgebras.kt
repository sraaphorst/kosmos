...
object ConstantMatrixAlgebras {
    ...
    class ConstantMatrixField<F : Any>(
        ...
        /**
         * Convenience function to avoid having to call into [DenseMatKernel] with the size.
         */
    ...
    class ConstantMatrixAlgebra<F : Any>(
        ...
        private val fieldOfConstantMatrices: ConstantMatrixField<F> =
            ConstantMatrixField(
                base = baseField,
                n = n,
            )
        ...
        override val scalars: CommutativeRing<F>
            get() = baseField
        override val add =
            fieldOfConstantMatrices.add
        override val mul =
            fieldOfConstantMatrices.mul
