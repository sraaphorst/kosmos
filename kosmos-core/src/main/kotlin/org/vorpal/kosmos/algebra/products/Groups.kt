...
object Groups {
    ...
    fun <L : Any, R : Any> leftProjection(
        left: Group<L>,
        right: Group<R>
    ): GroupHomomorphism<Pair<L, R>, L> = object : GroupHomomorphism<Pair<L, R>, L> {
    ...
    fun <L : Any, R : Any> rightProjection(
        left: Group<L>,
        right: Group<R>
    ): GroupHomomorphism<Pair<L, R>, R> = object : GroupHomomorphism<Pair<L, R>, R> {
        override val domain = product(left, right)
    ...
    fun <A : Any> diagonalEmbedding(
        obj: Group<A>
    ): GroupMonomorphism<A, Pair<A, A>> = object : GroupMonomorphism<A, Pair<A, A>> {
    ...
    fun <L : Any, R : Any> leftInjection(
        left: Group<L>,
        right: Group<R>
    ): GroupMonomorphism<L, Pair<L, R>> = object : GroupMonomorphism<L, Pair<L, R>> {
    ...
    fun <L : Any, R : Any> rightInjection(
        left: Group<L>,
        right: Group<R>
    ): GroupMonomorphism<R, Pair<L, R>> = object : GroupMonomorphism<R, Pair<L, R>> {
