package org.vorpal.kosmos.algebra.instances
...
val Z2Additive : AbelianGroup<Int> = object : AbelianGroup<Int> {
    ...
    override val inv: (Int) -> Int = Identity()
    override val op: BinOp<Int> = BinOp({ a, b -> (a + b) % 2}, "+")
}

val Z2Multiplicative : AbelianGroup<Int> = object : AbelianGroup<Int> {
    override val identity: Int = 1
    override val inv: (Int) -> Int = Identity()
    override val op: BinOp<Int> = BinOp({ a, b -> (a * b) }, "*")
}
